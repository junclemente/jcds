...
- Update .gitcliff.toml file; add Makefile
- Update .gitcliff.toml and Makefile
- Update parser

### 🚜 Refactor

- Update directory structure to use src/ layout

### ⚙️ Miscellaneous Tasks

- Add changelot for v0.2.4
- Add changelot for v0.2.4
- Add automatic changelog generation with GitCliff
- Test v0.2.5 changelog visibility
- Manually add v0.2.5 changelog for src/ layout
...
- Add data_quality() report function
