...
def plot_roc(y_true, y_score, model_name=None, ax=None, show=True):
    ...
    Args:
        ...
        y_score (array-like): Predicted scores or probabilities (not hard labels).
        model_name (str, optional): Name of the model for the legend label.
        ax (matplotlib.axes.Axes, optional): Axis to plot on. Creates one if None.
        show (bool): Whether to call plt.show(). Set to False when plotting multiple curves.
